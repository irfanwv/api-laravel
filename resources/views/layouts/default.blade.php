<!DOCTYPE html>
<!--[if IE 9]> <html lang="en" class="ie9" ng-app="p2p"> <![endif]-->
<!--[if !IE]><!-->
<html lang="en" ng-app="p2p">
  ...
  <body class="no-trans front-page transparent-header ">
    ...
    <div class="page-wrapper">
              ...
              <div class="col-xs-3 col-sm-6 col-md-9">
                ...
                <div class="header-top-first clearfix">
                  <ul class="social-links circle small clearfix hidden-xs">
                    <li class="twitter"><a target="_blank" href="//www.twitter.com"><i class="fa fa-twitter"></i></a></li>
                    <li class="skype"><a target="_blank" href="//www.skype.com"><i class="fa fa-skype"></i></a></li>
                    <li class="linkedin"><a target="_blank" href="//www.linkedin.com"><i class="fa fa-linkedin"></i></a></li>
                    <li class="googleplus"><a target="_blank" href="//plus.google.com"><i class="fa fa-google-plus"></i></a></li>
                    <li class="youtube"><a target="_blank" href="//www.youtube.com"><i class="fa fa-youtube-play"></i></a></li>
                    <li class="flickr"><a target="_blank" href="//www.flickr.com"><i class="fa fa-flickr"></i></a></li>
                    <li class="facebook"><a target="_blank" href="//www.facebook.com"><i class="fa fa-facebook"></i></a></li>
                    <li class="pinterest"><a target="_blank" href="//www.pinterest.com"><i class="fa fa-pinterest"></i></a></li>
                  </ul>
      ...
      <!--Root View-->
      <div ui-view class="shuffle-animation page-padding clearfix" autoscroll="true"></div>
                  ...
                  <div class="footer-content">
                    ...
                    <nav>
                      <ul class="nav nav-pills nav-stacked">
                        <li><a target="_blank" href="//htmlcoder.me/support">Support</a></li>
                ...
                <div class="col-md-3">
                  <div class="footer-content">
                    ...
                    <ul class="social-links circle animated-effect-1">
                      ...
                      <li class="googleplus"><a target="_blank" href="//plus.google.com"><i class="fa fa-google-plus"></i></a></li>
                      <li class="linkedin"><a target="_blank" href="//www.linkedin.com"><i class="fa fa-linkedin"></i></a></li>
                      <li class="xing"><a target="_blank" href="//www.xing.com"><i class="fa fa-xing"></i></a></li>
                    </ul>
                    <div class="separator-2"></div>
                    <ul class="list-icons">
        ...
        <div class="subfooter">
          <div class="container">
            <div class="subfooter-inner">
              <div class="row">
                <div class="col-md-12">
                  <p class="text-center">Copyright © 2015 The Project by <a target="_blank" href="//htmlcoder.me">HtmlCoder</a>. All Rights Reserved</p>
                </div>
              </div>
            </div>
          </div>
